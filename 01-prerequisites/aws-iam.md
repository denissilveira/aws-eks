...
According AWS Best Practices you should *never* use your root account for working with AWS services. E.g. to demonstrate the Hands-On lectures, the user _eks-key_ has been used.
...
* click _Next: Review_
* enter a *unique* Role name, _EKS-role_ and click *_Create Role_*
